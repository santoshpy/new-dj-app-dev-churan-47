...
## Project Structure
    ...
    ├── new_dj_app_dev_churan_47  # Django project configurations
...
1. Clone this repo and `cd new_dj_app_dev_churan_47`
...
2. Clone this repo and `cd new_dj_app_dev_churan_47`
